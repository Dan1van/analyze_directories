...
class Statist:
    def __init__(self, arguments: argparse.Namespace):
        ...
        self.downloader = am.downloaders[self.args.source]
        self.language_module = am.language_modules[self.args.language]
        self.analyser = am.analysers[self.args.part_of_speech]
        self.output = am.outputs[self.args.output_format]
